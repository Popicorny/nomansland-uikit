...
var getFontSize = function (_a) {
    ...
    return small ? "14px" : fontSize || "18px";
};
...
var Container$5 = styled.div(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement("img", { width: "8", src: "/images/snow.png", alt: "" }))); });
...
var StyledBunnyPlaceholder = styled(Icon$1H)(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$11, { color: props.color ? props.color : "primary", ml: "4px" })));
};
...
var templateObject_1$t, templateObject_2$h, templateObject_3$a, templateObject_4$6, templateObject_5$4, templateObject_6$2, templateObject_7$1;
...
var Container$4 = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
styled(Icon$k)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
styled(Icon$l)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    _a.size;
    return (React.createElement(Container$4, null,
        React.createElement("img", { src: "/images/loader.gif", alt: "Loading..." })));
};
...
var templateObject_1$p, templateObject_2$e, templateObject_3$7, templateObject_4$3, templateObject_5$1, templateObject_6$1, templateObject_7;
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #3CC8EE, 0px 0px 0px 4px rgba(60, 200, 238, 0.6)",
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#063B53", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#ffffff", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#FFFFFF", textDisabled: "#BDC2C4", textSubtle: "#063B53", disabled: "#E9EAEB", gradients: {
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React.createElement(Icon$1v, { color: "secondary" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$1U, { color: "secondary" })));
};
...
var Icon$2 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props, { style: { height: "18px", marginTop: "-4px" } }),
...
styled(Link$1)(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Logo = function (_a) {
    ...
    (React.createElement(React.Fragment, null,
        React.createElement(Icon$1f, { className: "mobile-icon" }),
        React.createElement(LogoWithText, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$g, { width: "24px", color: "white" })) : (React.createElement(Icon$h, { width: "24px", color: "white" })))));
};
...
var socials = [
    {
        label: "Discord",
        icon: "DiscordIcon",
        href: "https://discord.gg/3gpx8SFZtU",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/nomanslandnft",
    },
    {
        label: "Opensea",
        icon: "OpenseaIcon",
        href: "https://opensea.io/collection/nomanslandnft",
    },
];
var MENU_HEIGHT = 64;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            isOpen ? React.createElement(Icon$1R, null) : React.createElement(Icon$1S, null)),
...
var SocialLinks = function () { return (React.createElement(Flex, null, socials.map(function (social, index) {
    ...
    var mr = index < socials.length - 1 ? "8px" : "16px";
    /*
    if (social.items) {
      return (
        <Dropdown key={social.label} position="top" target={<Icon {...iconProps} ml={ml} mr={mr} />}>
...
var TabMenu = function (_a) {
    ...
    return (React.createElement(Container, null, links.map(function (entry) {
        ...
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                React.createElement(LinkLabelMemo, { isActive: entry.href === location.pathname, isPushed: isPushed }, entry.label))));
    })));
};
...
var CenterFlex = styled(Flex)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  align-items: center;\n"], ["\n  align-items: center;\n"])));
var Menu$1 = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu }, isMobile ?
            React.createElement(React.Fragment, null,
                React.createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
                userMenu)
            : React.createElement(React.Fragment, null,
                React.createElement(CenterFlex, null,
                    React.createElement(SocialLinks$1, null),
                    userMenu),
                React.createElement(Flex, null,
                    React.createElement(TabMenu, { isPushed: isPushed, isMobile: isSmallerScreen, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links })))),
...
var MoreWalletCard = function (_a) {
    ...
    return (React.createElement(WalletButton, __assign({ variant: "tertiary" }, props),
        React.createElement(Icon$14, { width: "40px", mb: "8px", color: "textSubtle" }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(ModalContainer, { minWidth: "320px" },
        React.createElement(ModalHeader, { background: getThemeValue("colors.gradients.bubblegum")(theme) },
            React.createElement(ModalTitle, null,
                React.createElement(Heading, { style: { color: "#063B53" } }, t("Connect Wallet"))),
...
export { Icon$1V as AddIcon, Alert, Icon$1U as ArrowBackIcon, Icon$1T as ArrowDownIcon, Icon$1S as ArrowDropDownIcon, Icon$1R as ArrowDropUpIcon, Icon$1Q as ArrowFirstIcon, Icon$1P as ArrowForwardIcon, Icon$1O as ArrowLastIcon, Icon$1N as ArrowUpIcon, Icon$1M as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1K as BinanceChainIcon, Icon$1L as BinanceIcon, Icon$1X as BlockIcon, Icon$1J as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1I as BunnyCardsIcon, Icon$1H as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1E as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1F as CardViewIcon, Icon$1G as Cards, GridLayout as CardsLayout, Icon$1C as ChartIcon, Checkbox, Icon$1A as CheckmarkCircleFillIcon, Icon$1Z as CheckmarkCircleIcon, Icon$1B as CheckmarkIcon, Icon$1z as ChevronDownIcon, Icon$1y as ChevronLeftIcon, Icon$1x as ChevronRightIcon, Icon$1w as ChevronUpIcon, Icon$1D as CircleOutlineIcon, Icon$1v as CloseIcon, Icon$1u as CogIcon, Icon$1t as Coin98Icon, Icon$1s as CommunityIcon, ConnectorNames, Icon$1r as CopyIcon, Icon$1q as CrownIcon, Icon$1p as CurrencyIcon, Dropdown, Icon$1o as EllipsisIcon, Icon$1Y as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Grid, Heading, Icon$1n as HelpIcon, Icon$1m as HistoryIcon, IconButton, Image, Icon$1W as InfoIcon, Input$1 as Input, InputGroup, Icon$1k as LanguageCurrencyIcon, Icon$1l as LanguageIcon, Icon$1j as LaurelLeftIcon, Icon$1i as LaurelRightIcon, Link, LinkExternal, Icon$1h as ListViewIcon, Icon$1g as LoginIcon, Icon$1f as LogoIcon, Icon$1e as LogoRoundIcon, Icon$1c as LogoutIcon, Icon$1d as MathWalletIcon, Icon$1b as MedalBronzeIcon, Icon$1a as MedalGoldIcon, Icon$19 as MedalPurpleIcon, Icon$18 as MedalSilverIcon, Icon$17 as MedalTealIcon, Menu$1 as Menu, Message, Icon$16 as MetamaskIcon, Icon$15 as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$14 as MoreHorizontalIcon, Icon$13 as MoreVerticalIcon, Icon$12 as NoProfileAvatarIcon, NotificationDot, Icon$11 as OpenNewIcon, Overlay, Icon$_ as PancakeRoundIcon, PancakeToggle, Icon$10 as PancakesIcon, Icon$$ as PencilIcon, Icon$Y as PlayCircleOutlineIcon, Icon$Z as PocketWatchIcon, Icon$X as PredictionsIcon, Icon$R as PresentCheckIcon, Icon$P as PresentNoneIcon, Icon$Q as PresentWonIcon, Icon$W as PrizeIcon, ProfileAvatar, Progress, Icon$S as ProgressBunny, Icon$V as ProposalIcon, Radio, Icon$O as RefreshIcon, Icon$U as RemoveIcon, ResetCSS, Icon$N as SafePalIcon, Icon$M as SearchIcon, Skeleton, Slider, Icon$L as SmallDotIcon, Spinner, Icon$K as StarFillIcon, Icon$J as StarLineIcon, Step, Stepper, SubMenu, SubMenuItem, Svg, Icon$I as SwapIcon, Icon$H as SwapVertIcon, Icon$G as SyncAltIcon, Tab, ButtonMenu as TabMenu, Table, Tag, Td, Icon$F as TeamPlayerIcon, Icon$E as TestnetIcon, Text, Th, Icon$D as Ticket, Icon$C as TicketFillIcon, Icon$B as TicketRound, Icon$A as TimerIcon, Toggle, TokenImage, TokenPairImage, Icon$z as TokenPocketIcon, TooltipText, Icon$y as TrophyGoldIcon, Icon$x as TrustWalletIcon, Icon$w as TuneIcon, UserMenu, UserMenuDivider, UserMenuItem, Icon$T as VerifiedIcon, Icon$v as VisibilityOff, Icon$u as VisibilityOn, Icon$t as VolumeOffIcon, Icon$s as VolumeUpIcon, Icon$r as VoteIcon, Icon$m as WaitIcon, Icon$p as WalletConnectIcon, Icon$n as WalletFilledIcon, Icon$o as WalletIcon, Icon$q as WarningIcon, variants$4 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
