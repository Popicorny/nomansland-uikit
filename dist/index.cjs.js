...
var Container$5 = styled__default['default'].div(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default['default'].createElement("img", { width: "8", src: "/images/snow.png", alt: "" }))); });
...
var StyledBunnyPlaceholder = styled__default['default'](Icon$1H)(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var Container$4 = styled__default['default'].div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
styled__default['default'](Icon$k)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
styled__default['default'](Icon$l)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    _a.size;
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement("img", { src: "/images/loader.gif", alt: "Loading..." })));
};
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default['default'].createElement(Icon$1v, { color: "secondary" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React__default['default'].createElement(Icon$1U, { color: "secondary" })));
};
...
var Icon$2 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props, { style: { height: "18px", marginTop: "-4px" } }),
...
styled__default['default'](reactRouterDom.Link)(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$g, { width: "24px", color: "white" })) : (React__default['default'].createElement(Icon$h, { width: "24px", color: "white" })))));
};
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            isOpen ? React__default['default'].createElement(Icon$1R, null) : React__default['default'].createElement(Icon$1S, null)),
...
var TabMenu = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null, links.map(function (entry) {
        ...
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                React__default['default'].createElement(LinkLabelMemo, { isActive: entry.href === location.pathname, isPushed: isPushed }, entry.label))));
    })));
};
...
var CenterFlex = styled__default['default'](Flex)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  align-items: center;\n"], ["\n  align-items: center;\n"])));
var Menu$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu }, isMobile ?
            React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
                userMenu)
            : React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement(CenterFlex, null,
                    React__default['default'].createElement(SocialLinks$1, null),
                    userMenu),
                React__default['default'].createElement(Flex, null,
                    React__default['default'].createElement(TabMenu, { isPushed: isPushed, isMobile: isSmallerScreen, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links })))),
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(ModalContainer, { minWidth: "320px" },
        React__default['default'].createElement(ModalHeader, { background: getThemeValue("colors.gradients.bubblegum")(theme) },
            React__default['default'].createElement(ModalTitle, null,
                React__default['default'].createElement(Heading, { style: { color: "#063B53" } }, t("Connect Wallet"))),
...
exports.ArrowFirstIcon = Icon$1Q;
exports.ArrowForwardIcon = Icon$1P;
exports.ArrowLastIcon = Icon$1O;
...
exports.BinanceChainIcon = Icon$1K;
...
exports.CheckmarkCircleFillIcon = Icon$1A;
...
exports.LanguageCurrencyIcon = Icon$1k;
